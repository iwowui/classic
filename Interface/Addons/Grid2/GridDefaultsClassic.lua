...
function Grid2:MakeDefaultsCommon()
	...
	Grid2:DbSetValue( "indicators", "power", {type = "bar", level = 3, backColor = {r=0,g=0,b=0,a=1}, orientation = "VERTICAL", opacity = 1, location = {x=0,y=0,relPoint="RIGHT",point="RIGHT"}, width = 10, })
	Grid2:DbSetMap( "power", "mana", 50)
	Grid2:DbSetValue( "indicators",  "power-color", {type = "bar-color"})
	Grid2:DbSetMap( "power-color", "power", 50)
end
