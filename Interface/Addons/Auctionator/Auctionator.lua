...
function Atr_Duration_Initialize(self)
  ...
  Atr_Dropdown_AddPick (self, "2 "..GetText("HOURS", nil, 2), 1, Atr_Duration_OnClick);
  Atr_Dropdown_AddPick (self, "8 "..GetText("HOURS", nil, 2), 2, Atr_Duration_OnClick);
  Atr_Dropdown_AddPick (self, "24 "..GetText("HOURS", nil, 2), 3, Atr_Duration_OnClick);
