...
elseif GetLocale() == "zhTW" then
	ItemRack.DefaultEvents = {
		...
		["騎術裝"] = { Type = "Buff", Unequip = 1, Anymount = 1 },
		["喝水中"] = { Type = "Buff", Unequip = 1, Buff = "喝水" },
		["喚醒"] = { Type = "Buff", Unequip = 1, Buff = "喚醒" },
		["戰鬥姿態"] = { Type = "Stance", Stance = 1 },
		["防禦姿態"] = { Type = "Stance", Stance = 2 },
		["狂暴姿態"] = { Type = "Stance", Stance = 3 },
		["暗影形態"] = { Type = "Stance", Unequip = 1, Stance = 1 },
		["德魯伊人型"] = { Type = "Stance", Stance = 0 },
		["德魯伊熊"] = { Type = "Stance", Stance = 1 },
		["德魯伊水棲"] = { Type = "Stance", Stance = 2 },
		["德魯伊獵豹"] = { Type = "Stance", Stance = 3 },
		["德魯伊旅行"] = { Type = "Stance", Stance = 4 },
		["德魯伊梟獸"] = { Type = "Stance", Stance = "梟獸形態" },
		["德魯伊樹"] = { Type = "Stance", Stance = "Tree of Life" },
		["德魯伊飛行"] = { Type = "Stance", Unequip = 1, Stance = "Flight Form" },
		["德魯伊迅捷飛行"] = { Type = "Stance", Unequip = 1, Stance = "Swift Flight Form" },
		["潛行"] = { Type = "Stance", Unequip = 1, Stance = 1 },
		["幽魂之狼"] = { Type = "Stance", Unequip = 1, Stance = 1 },
		["游泳中"] = {
			["Trigger"] = "MIRROR_TIMER_START",
			["Type"] = "Script",
