...
LibItemStatsPatterns = {
	...
	general = {
		...
		{ key = "AttackDamage", pattern = "武器伤害" },
		{ key = "RangedAttackDamage", pattern = "瞄准镜" },
		{ key = "RangedHitRating", pattern = "^%+(%d+)%% 命中$" },
	},
	extra = {
		...
		{ key = "SpellHitRating", percent = true, pattern = "使你的法术击中敌人的几率提高(%d+)%%" },
		-- { key = "HasteSpell", pattern = "法术急速等级提高(%d+)" },
		-- { key = "SpellCrit", pattern = "法术爆击等级提高(%d+)" },
		{ key = "SpellCrit", percent = true, pattern = "使你的法术造成爆击的几率提高(%d+)%%" },
		...
		{ key = "AttackCrit|RangedAttackCrit", percent = true, pattern = "使你造成爆击的几率提高(%d+)%%" },	
		{ key = "AttackPower|RangedAttackPower", pattern = "攻击强度提高(%d+)" },
		-- { key = "HitRating", pattern = "命中等级提高(%d+)" },
		{ key = "HitRating", percent = true, pattern = "使你击中目标的几率提高(%d+)%%" },
		-- { key = "Parry", pattern = "招架等级提高(%d+)" },
		-- { key = "Defense", pattern = "防御等级提高(%d+)" },
		{ key = "Defense", pattern = "防御技能提高(%d+)点" },
		-- { key = "Dodge", pattern = "躲闪等级提高(%d+)" },
		{ key = "Dodge", percent = true, pattern = "使你躲闪攻击的几率提高(%d+)%%" },
		{ key = "Blockvalue", pattern = "盾牌格挡值提高(%d+)" },
		-- { key = "Block", pattern = "格挡等级提高(%d+)" },
		-- { key = "Block", pattern = "盾牌格挡等级(%d+)" },
		{ key = "Block", percent = true, pattern = "使你用盾牌格挡攻击的几率提高(%d+)%%" },
		{ key = "Block", percent = true, pattern = "+(%d+)%% 格挡" },
		...
		{ key = "Parry", percent = true, pattern = "使你招架攻击的几率提高(%d+)%%" },
		-- { key = "Defense", pattern = "提高防御等级(%d+)" },
		-- { key = "Dodge", pattern = "提高躲闪等级(%d+)" },

		{ key = "Healing", pattern = "提高法术和魔法效果所造成的治疗效果，最多(%d+)点。" },
		{ key = "Healing", pattern = "使法术的治疗效果提高最多(%d+)点。" },
		{ key = "Healing", pattern = "使治疗法术和效果所回复的生命值提高(%d+)点。" },
		{ key = "Healing", pattern = "提高法术所造成的治疗效果，最多(%d+)点。" },

		{ key = "Blockvalue", pattern = "使你的盾牌的格挡值提高(%d+)点" },
		{ key = "Blockvalue", pattern = "^(%d+)格挡" },
		{ key = "Blockvalue", pattern = "^(%d+)点格挡" },

		{ key = "Daggerskill", pattern = "匕首技能提高(%d+)点" },
		{ key = "Oneaxeskill", pattern = "斧类武器技能提高(%d+)点" },
		{ key = "Twoaxeskill", pattern = "双手斧技能提高(%d+)点" },
		{ key = "Oneswordskill", pattern = "剑类武器技能提高(%d+)点" },
		{ key = "Twoswordskill", pattern = "双手剑技能提高(%d+)点" },
		{ key = "Onemaceskill", pattern = "锤类武器技能提高(%d+)点" },
		{ key = "Twomaceskill", pattern = "双手锤技能提高(%d+)点" },
		{ key = "Bowskill", pattern = "弓箭技能提高(%d+)点" },
		{ key = "Gunsskill", pattern = "枪械技能提高(%d+)点" },
		{ key = "Crossbowskill", pattern = "弩技能提高(%d+)点" },
	...
	buff = {
		...
		{ key = "ManaRestore", pattern = "每5秒恢复(%d+)点法力",},
		{ key = "ManaRestore", pattern = "每5秒回复(%d+)点法力",},
		{ key = "HealthRestore", pattern = "每5秒恢复(%d+)点生命",},
		{ key = "HealthRestore", pattern = "每5秒回复(%d+)点生命",},
		...
		{ key = "ArmorReduce", pattern = "受到物理攻击时承受的伤害降低(%d+)%%",},	
	},
}
