...
L["can be created from reagents in your inventory"] = "個可用背包內的材料製作"
...
L["Show favorite recipes only. Click on a star on the left side of a recipe to set favorite."] = "只顯示最愛的配方。點 一下配方左側的星形圖示來設為最愛。"
