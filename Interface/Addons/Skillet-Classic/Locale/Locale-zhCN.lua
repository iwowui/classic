...
L["can be created from reagents in your inventory"] = "个可由背包中的材料制造"
L["can be created from reagents on all characters"] = "个可从所有人物的材料制造"
L["can be created from reagents on other characters"] = "个可由其他人物的材料制造"
L["can be created with reagents bought at vendor"] = "个可通过从商人处购买材料制造"
