...
-- Auto generated on 12/14/2006 1:28:06 PM
...
RecipeRadar_NameMap = {
   ...
   ["deDE"] = {
      ...
      ["Goblin-Überbrückungskabel"] = "Goblinüberbrückungskabel",
   ...
   ["frFR"] = {
      ...
      ["Elixir de Tueur de démons"] = "Elixir de tueur de démons",
      ["Potion de soins majeure"] = "Potion de Soins majeure",
      ["Potion de sommeil sans rêve supérieure"] = "Sommeil sans rêve supérieur",
      ...
      ["Ench. de bracelets (Force inférieure)"] = "Enchantement de bracelets (Force inférieure)",
      ["Ench. de bracelets (Déviation inférieure)"] = "Enchantement de bracelets (Déviation inférieure)",
      ["Ench. de bracelets (Déviation)"] = "Enchantement de bracelets (Déviation)",
      ["Ench. de bouclier (Endurance supérieure)"] = "Enchantement de bouclier (Endurance supérieure)",
      ["Ench. de plastron (Vie majeure)"] = "Enchantement de plastron (Santé majeure)",
      ...
      ["Ench. de bracelets (Régénération de mana)"] = "Enchantement de bracelets (Régénération de mana)",
      ["Ench. d'arme 2M (Agilité)"] = "Enchantement d'arme 2M (Agilité)",
      ["Ench. de bracelets (Pouvoir de guérison)"] = "Enchantement de bracelets (Soin)",
      ...
      ["Jambières de l'ours de guerre"] = "Haut-de-chausses de l'ours de guerre",
      -- Tailoring
      ["Jambières en vignesang"] = "Jambières  en vignesang",
      -- Cooking
