...
L.HOW_TO_USE_MOD					= "歡迎使用DBM。在聊天頻道輸入 /dbm 打開設定開始設定。你可以載入特定區域後為任何首領設定你喜歡的特別設置。DBM會在設定你的職業天賦的預設值，但有些選項可能需要調整。"
L.SILENT_REMINDER					= "提醒：DBM正處於無聲模式。"
...
L.BAD_LOAD					= "DBM偵測到你的此副本的模組在戰鬥中讀取失敗。一旦脫離戰鬥，請立即輸入/console reloadui重新載入。"
L.LOAD_MOD_VER_MISMATCH		= "%s不能被讀取因為你的DBM-Core未達需求，請更新版本。"
...
L.DYNAMIC_DIFFICULTY_CLUMP	= "DBM已中禁用動態距離框架，你目前的團隊人數在這場戰鬥中的機制資訊不足。"
L.DYNAMIC_ADD_COUNT			= "DBM已中禁用小怪計數警告，你目前的團隊人數在這場戰鬥中的機制資訊不足。"
L.DYNAMIC_MULTIPLE			= "DBM已中禁用多項功能，你目前的團隊人數在這場戰鬥中的機制資訊不足。"

L.LOOT_SPEC_REMINDER			= "你目前的專精為:%s。而你目前的拾取選擇為:%s。"

L.BIGWIGS_ICON_CONFLICT		= "DBM偵測到你同時開啟BigWigs和DBM的團隊圖示。請關閉其中之一的團隊圖示功能以免與產生衝突。"

L.MOD_AVAILABLE				= "%s的DBM插件已經可供使用。你可以在|HDBM:forums|h|cff3588ffdeadlybossmods.com|r或Curse上找到。此訊息只會顯示一次。."
...
L.MOVIE_SKIPPED				= "DBM已嘗試自動略過場動畫。"

L.AFK_WARNING				= "你正在AFK和戰鬥中(血量還剩餘%d百分比)所以發出警告。如果你沒在AFK，請清除AFK的標籤或是在額外功能禁用此選項。"
...
L.VERSIONCHECK_ENTRY			= "%s：%s (r%d) %s"
L.VERSIONCHECK_ENTRY_TWO		= "%s：%s (r%d) & %s (r%d)"
...
L.YOUR_VERSION_OUTDATED		= "你的 Deadly Boss Mod 已經過期。請到http://www.deadlybossmods.com下載最新版本。"
L.VOICE_PACK_OUTDATED		= "你所選的DBM語音包可能缺少一些DBM支援的的語音。部分警告音效仍然會使用預設音效播放。請下載新版本的語音包或是聯絡語音包作者更新並加入缺少的語音。"
L.VOICE_MISSING				= "DBM找不到你所選取的語音包。你的語音包選項已經被重置為'None'。請確定你的語音包已正確的安裝與啟用。"
...
--L.UPDATEREMINDER_DISABLE			= "警告: 你的DBM版本已過期太多版本(至少過期%d個版本)，DBM已被強制禁用了而不能啟用除非更新至最新版本。這是為了確保舊而不相容的程式碼不會對你而團隊夥伴造成低落的遊戲體驗。"
L.UPDATEREMINDER_NODISABLE		= "警告: 你的DBM版本已大幅過期。此訊息在過了某個門檻之後會不能被禁用，強烈建議更新。"
L.UPDATEREMINDER_HOTFIX			= "你的DBM版本會在這首領戰鬥有不準確的計時器或警告。這問題已被修正在新版正式版"
L.UPDATEREMINDER_HOTFIX_ALPHA	= "你的DBM版本會在這首領戰鬥有不準確的計時器或警告。這問題已被修正在新版正式版(或是更新到最新的alpha)"
...
L.OUT_OF_DATE_NAG				= "你的DBM版本已經過期你設定忽略彈出更新提示。還是建議你更新避免缺少一些重要的警告或是計時器，而其他人也看不到從你發出的大喊警告。"
...
L.INFOFRAME_SETLINES			= "設定最大線條數"
L.INFOFRAME_LINESDEFAULT		= "由模組設定"
L.INFOFRAME_LINES_TO			= "%d線條"
...
L.AUTO_ANNOUNCE_OPTIONS.you			= "提示當你中了$spell:%s"
L.AUTO_ANNOUNCE_OPTIONS.target		= "提示$spell:%s的目標"
L.AUTO_ANNOUNCE_OPTIONS.targetsource	= "提示$spell:%s的目標(來源)"
L.AUTO_ANNOUNCE_OPTIONS.targetcount	= "提示$spell:%s的目標(次數)"
L.AUTO_ANNOUNCE_OPTIONS.spell		= "為$spell:%s顯示警告"
L.AUTO_ANNOUNCE_OPTIONS.ends			= "為$spell:%s結束顯示警告"
L.AUTO_ANNOUNCE_OPTIONS.endtarget	= "為$spell:%s結束顯示警告"
L.AUTO_ANNOUNCE_OPTIONS.fades		= "為$spell:%s消退顯示警告"
L.AUTO_ANNOUNCE_OPTIONS.adds			= "提示$spell:%s的剩餘數量"
L.AUTO_ANNOUNCE_OPTIONS.cast			= "當$spell:%s施放時顯示警告"
L.AUTO_ANNOUNCE_OPTIONS.soon			= "為$spell:%s顯示預先警告"
L.AUTO_ANNOUNCE_OPTIONS.sooncount	= "為$spell:%s顯示預先警告"
L.AUTO_ANNOUNCE_OPTIONS.prewarn		= "為$spell:%s顯示預先警告"
L.AUTO_ANNOUNCE_OPTIONS.bait			= "為$spell:%s顯示去引誘的預先警告"
L.AUTO_ANNOUNCE_OPTIONS.stage		= "提示第%s階段"
L.AUTO_ANNOUNCE_OPTIONS.stagechange	= "提示階段轉換"
L.AUTO_ANNOUNCE_OPTIONS.prestage		= "為第%s階段顯示預先警告"
L.AUTO_ANNOUNCE_OPTIONS.count		= "為$spell:%s顯示警告(次數)"
L.AUTO_ANNOUNCE_OPTIONS.stack		= "提示$spell:%s的堆疊"
...
L.AUTO_SPEC_WARN_OPTIONS.spell		= "為$spell:%s顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.ends 		= "為$spell:%s結束顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.fades 		= "為$spell:%s消退顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.soon 		= "為$spell:%s顯示預先特別警告"
L.AUTO_SPEC_WARN_OPTIONS.sooncount	= "為$spell:%s(次數)顯示預先特別警告"
L.AUTO_SPEC_WARN_OPTIONS.bait		= "為$spell:%s(當誘餌)顯示預先特別警告"
L.AUTO_SPEC_WARN_OPTIONS.prewarn 	= "在%s秒前為$spell:%s顯示預先特別警告"
L.AUTO_SPEC_WARN_OPTIONS.dispel		= "需對$spell:%s驅散/竊取時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.interrupt	= "需對$spell:%s斷法時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.interruptcount	= "需對$spell:%s斷法(次數)時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.you			= "當你中了$spell:%s時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.youcount	= "當你中了$spell:%s時(次數)顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.youpos		= "當你中了$spell:%s時(站位)顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.soakpos		= "當需要為$spell:%s踩圈分擔時(站位)顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.target		= "當有人中了$spell:%s時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.targetcount	= "當有人中了$spell:%s時(次數)顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.defensive	= "需對$spell:%s使用防禦技能時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.taunt 		= "當其他坦克中了$spell:%s顯示特別警告去嘲諷"
L.AUTO_SPEC_WARN_OPTIONS.close		= "當你附近有人中了$spell:%s時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.move		= "當需要移動出$spell:%s時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.keepmove 	= "當需要為$spell:%s保持移動時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.stopmove 	= "當需要為$spell:%s停止移動時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.dodge 		= "當需要閃避$spell:%s時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.dodgecount	= "當需要閃避$spell:%s(次數)時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.dodgeloc	= "當需要閃避$spell:%s時(站位)顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.moveaway	= "當你中了$spell:%s要跑離開其他人時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.moveawaycount	= "當你中了$spell:%s要跑離開其他人時(次數)顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.moveto		= "為$spell:%s需要跑向某人或某地時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.soak		= "為$spell:%s踩圈分擔時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.jump		= "當你中了$spell:%s需跳起來時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.run			= "為$spell:%s顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.cast		= "為$spell:%s施放時顯示停止施法的特別警告"
L.AUTO_SPEC_WARN_OPTIONS.lookaway	= "當需要為$spell:%s轉身時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.reflect		= "為$spell:%s施放時顯示停止攻擊的特別警告"
L.AUTO_SPEC_WARN_OPTIONS.count 		= "為$spell:%s顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.stack		= "為中了>=%d層$spell:%s時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.switch		= "為$spell:%s顯示特別警告去更換目標"
L.AUTO_SPEC_WARN_OPTIONS.switchcount = "為$spell:%s顯示特別警告(次數)去更換目標"
L.AUTO_SPEC_WARN_OPTIONS.gtfo 		= "為離開地上危險的技能時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.adds		= "為到來的小怪更換目標時顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.addscustom	= "為到來的小怪顯示特別警告"
L.AUTO_SPEC_WARN_OPTIONS.targetchange	= "為改變目標的優先順序顯示特別警告"
...
L.AUTO_TIMER_OPTIONS.target			= "為$spell:%s顯示減益計時器"
L.AUTO_TIMER_OPTIONS.cast			= "為$spell:%s顯示施法計時器"
L.AUTO_TIMER_OPTIONS.castcount		= "為$spell:%s(次數)顯示施法計時器"
L.AUTO_TIMER_OPTIONS.castsource		= "為$spell:%s的施法來源顯示計時器"
L.AUTO_TIMER_OPTIONS.active			= "為$spell:%s顯示持續時間計時器"
L.AUTO_TIMER_OPTIONS.fades			= "當$spell:%s將從玩家消退顯示計時器"
L.AUTO_TIMER_OPTIONS.ai				= "為$spell:%s顯示AI計時器"
L.AUTO_TIMER_OPTIONS.cd				= "為$spell:%s顯示冷卻計時器"
L.AUTO_TIMER_OPTIONS.cdcount			= "為$spell:%s顯示冷卻計時器"
L.AUTO_TIMER_OPTIONS.cdsource		= "為$spell:%s顯示冷卻計時器"
L.AUTO_TIMER_OPTIONS.cdspecial		= "為特別技能顯示冷卻計時器"
L.AUTO_TIMER_OPTIONS.next			= "為下一次$spell:%s顯示計時器"
L.AUTO_TIMER_OPTIONS.nextcount		= "為下一次$spell:%s顯示計時器"
L.AUTO_TIMER_OPTIONS.nextsource		= "為下一次$spell:%s顯示計時器"
L.AUTO_TIMER_OPTIONS.nextspecial		= "為下一次特別技能顯示計時器"
L.AUTO_TIMER_OPTIONS.achievement		= "為成就:%s顯示計時器"
L.AUTO_TIMER_OPTIONS.stage			= "為下一個階段顯示計時器"
L.AUTO_TIMER_OPTIONS.adds			= "為到來的小怪顯示計時器"
L.AUTO_TIMER_OPTIONS.addscustom		= "為到來的小怪顯示計時器"
L.AUTO_TIMER_OPTIONS.roleplay		= "為角色扮演持續時間顯示計時器"
...
L.LAG_ENTRY					= "%s:世界延遲[%d毫秒]/家延遲[%d毫秒]"
L.LAG_FOOTER					= "無回應:%s"
