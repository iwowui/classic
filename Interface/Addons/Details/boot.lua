...
--> global name declaration
		...
		_ = nil --remove from global namespace
		_detalhes = LibStub("AceAddon-3.0"):NewAddon("_detalhes", "AceTimer-3.0", "AceComm-3.0", "AceSerializer-3.0", "NickTag-1.0")
		
		_detalhes.build_counter = 199
		_detalhes.alpha_build_counter = 199 --if this is higher than the regular counter, use it instead
