...
--> global name declaration
		...
		--remove the underline from the global namespace
		_ = nil 
		_detalhes = LibStub("AceAddon-3.0"):NewAddon("_detalhes", "AceTimer-3.0", "AceComm-3.0", "AceSerializer-3.0", "NickTag-1.0")
		
		_detalhes.build_counter = 207
		_detalhes.alpha_build_counter = 207 --if this is higher than the regular counter, use it instead
		_detalhes.game_version = "v1.13.4"
		_detalhes.userversion = "v1.13.4." .. _detalhes.build_counter
