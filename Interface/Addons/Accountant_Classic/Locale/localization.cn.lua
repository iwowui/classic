...
L["Data type to be displayed on LDB"] = "在 LDB 上要显示的数据类型"
...
L["Enable to show all characters' money info from all factions. Disable to only show all characters' info from current faction."] = "启用以显示来自所有阵营的所有角色的金流信息。停用则仅会显示目前阵营的角色信息。"
...
L["Enhanced Tracking Options"] = "更多的追踪选项"
L["Exit"] = "离开"
L["g "] = "金"
L["General and Data Display Format Settings"] = "一般与信息显示格式设定"
L["Incomings"] = "收入"
L["LDB Display Settings"] = "LDB 显示设置"
L["LDB Display Type"] = "LDB 显示类型"
L[ [=[Left-click and drag to move this button.
Right-Click to open Accountant Classic.]=] ] = [=[右键并拖曳以移动图示按钮位置
...
L["Mail"] = "邮寄"
L["Main Frame's Scale and Alpha Settings"] = "主窗口的大小与透明度"
L["Merchants"] = "商人"
L["Minimap Button Position"] = "小地图按钮位置"
L["Minimap Button Settings"] = "小地图按键设定"
L["Money"] = "金钱"
L["Net Loss"] = "净亏损"
L["Net Profit"] = "净收益"
L["Net Profit / Loss"] = "净收益/亏损"
L["New Accountant Classic profile created for %s"] = "%s的 Accountant Classic 数据已建立"
L["Onscreen Actionbar's Scale and Alpha Settings"] = "浮动窗口的大小与透明度"
L["Options"] = "选项"
L["Outgoings"] = "支出"
L["Profile Options"] = "配置文件"
L["Prv. Day"] = "上一日"
L["Prv. Month"] = "上一月"
L["Prv. Week"] = "上一周"
L["Prv. Year"] = "上一年"
L["Quest Rewards"] = "任务奖励"
L["Remember character selected"] = "保存选择的角色"
L["Remember the latest character selection in dropdown menu."] = "保存上次在下拉式选单所选择的角色。"
L["Repair Costs"] = "修理装备"
L["Reset"] = "归零"
