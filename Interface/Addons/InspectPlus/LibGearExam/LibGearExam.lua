...
local strstr = "%s %s"
local STR_DAGGERSKILL = "Increased Daggers Skill"
local STR_ONEAXESKILL = "Increased Axes Skill"
local STR_TWOAXESKILL = "Increased Two-Handed Axes Skill"
local STR_ONESWORDSKILL = "Increased Swords Skill"
local STR_TWOSWORDSKILL = "Increased Two-Handed Swords Skill"
local STR_ONEMACESKILL = "Increased Maces Skill"
local STR_TWOMACESKILL = "Increased Two-Handed Maces Skill"
local STR_BOWSKILL = "Increased Bows skill"
local STR_GUNSSKILL = "Increased Guns skill"
local STR_CROSSBOWSKILL = "Increased Crossbows Skill"
if GetLocale() == "zhCN" then
	strstr = "%s%s";
	STR_DAGGERSKILL = "提高匕首技能"
	STR_ONEAXESKILL = "提高单手斧技能"
	STR_TWOAXESKILL = "提高双手斧技能"
	STR_ONESWORDSKILL = "提高单手剑技能"
	STR_TWOSWORDSKILL = "提高双手剑技能"
	STR_ONEMACESKILL = "提高单手锤技能"
	STR_TWOMACESKILL = "提高双手锤技能"
	STR_BOWSKILL = "提高弓技能"
	STR_GUNSSKILL = "提高枪技能"
	STR_CROSSBOWSKILL = "提高弩技能"
elseif GetLocale() == "zhTW" then
	strstr = "%s%s";
	STR_DAGGERSKILL = "提高匕首技能"
	STR_ONEAXESKILL = "提高單手斧技能"
	STR_TWOAXESKILL = "提高雙手斧技能"
	STR_ONESWORDSKILL = "提高單手劍技能"
	STR_TWOSWORDSKILL = "提高雙手劍技能"
	STR_ONEMACESKILL = "提高單手錘技能"
	STR_TWOMACESKILL = "提高雙手錘技能"
	STR_BOWSKILL = "提高弓技能"
	STR_GUNSSKILL = "提高槍技能"
	STR_CROSSBOWSKILL = "提高弩技能"
end
...
-- Schools
LGE.MagicSchools = { "ARCANE", "FIRE", "NATURE", "FROST", "SHADOW", "HOLY" };
...
LGE.StatNames = {
	...
	SPELLCRIT = format(strstr, STAT_CATEGORY_SPELL, STAT_CRITICAL_STRIKE), --STAT_CATEGORY_SPELL.." "..STAT_CRITICAL_STRIKE,
	SPELLHIT = format(strstr, STAT_CATEGORY_SPELL, ACTION_SPELL_DAMAGE), --STAT_CATEGORY_SPELL.." "..ACTION_SPELL_DAMAGE,
	SPELLHASTE = format(strstr, STAT_CATEGORY_SPELL, STAT_HASTE), --STAT_CATEGORY_SPELL.." "..STAT_HASTE,
	...
	DAGGERSKILL = STR_DAGGERSKILL, --"Increased Daggers Skill",
	
	ONEAXESKILL = STR_ONEAXESKILL, --"Increased Axes Skill",
	TWOAXESKILL = STR_TWOAXESKILL, --"Increased Two-Handed Axes Skill",

	ONESWORDSKILL = STR_ONESWORDSKILL, --"Increased Swords Skill",
	TWOSWORDSKILL = STR_TWOSWORDSKILL, --"Increased Two-Handed Swords Skill",
	
	ONEMACESKILL = STR_ONEMACESKILL, --"Increased Maces Skill",
	TWOMACESKILL = STR_TWOMACESKILL, --"Increased Two-Handed Maces Skill",
	
	BOWSKILL = STR_BOWSKILL, --"Increased Bows skill",
	GUNSSKILL = STR_GUNSSKILL, --"Increased Guns skill",
	CROSSBOWSKILL = STR_CROSSBOWSKILL, --"Increased Crossbows Skill",
};
